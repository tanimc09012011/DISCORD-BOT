...
app.get('/api/admin/list', verifyAdmin, (req, res) => {
    res.json(admins.map(a => ({ 
        id: a.id, 
        email: a.isHead ? 'Hidden (Head Admin)' : a.email,
        name: a.name, 
        isHead: a.isHead, 
        status: a.status,
...
// Add Tick/Cross Reaction to Message
...
// Role Assign with Auto React Tick & Reaction Toggle
...
// Dynamic Port Fix for Railway & 0.0.0.0 Host Binding
